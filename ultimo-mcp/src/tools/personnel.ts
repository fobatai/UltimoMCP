...
export function registerPersonnelTools(server: McpServer) {
  // Employees
  server.tool(
    "get_employees",
...
Filter op Department, Site, of naam. Expand met EmployeeLabours voor urenregistratie.`,
    ...
    async (input) => {
      try {
        const result = await getObjects("Employee", buildOData(input));
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await getObject("Employee", input.id, { select: input.select, expand: input.expand });
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await createObject("Employee", input.data);
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await patchObject("Employee", input.id, input.data);
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
een medewerker op welke jobs heeft gewerkt. Essentieel voor urenbeheer en kostentoerekening.`,
    ...
    async (input) => {
      try {
        const result = await getObjects("EmployeeLabour", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
specifieke job op een specifieke dag. Filter op Employee of Job.`,
    ...
    async (input) => {
      try {
        const result = await getObjects("EmployeeLabourLine", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
(bijv. Elektricien, Monteur, Lasser) die aan medewerkers en jobs gekoppeld wordt.`,
    ...
    async (input) => {
      try {
        const result = await getObjects("Craftsman", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await getObjects("Department", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
de juiste persoon voor de juiste job te plannen.`,
    ...
    async (input) => {
      try {
        const result = await getObjects("SkillCategory", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
