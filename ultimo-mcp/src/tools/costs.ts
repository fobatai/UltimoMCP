...
Filter op Job, Equipment, CostType, of periode (RecordCreateDate).`,
    ...
    async (input) => {
      try {
        const result = await getObjects("Cost", buildOData(input));
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await createObject("Cost", input.data);
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
onderhoudskosten aan afdelingen of projecten.`,
    ...
    async (input) => {
      try {
        const result = await getObjects("CostCenter", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await getObjects("CostType", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
bijv. een renovatie of grote revisie. Handig voor budgetbewaking.`,
    ...
    async (input) => {
      try {
        const result = await getObjects("Project", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await getObjects("Account", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
