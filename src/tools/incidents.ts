...
export function registerIncidentTools(server: McpServer, client: UltimoClient) {
  // Incidents
  server.tool(
    "get_incidents",
...
Filter op IncidentType, Status, Equipment, of datum.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("Incident", buildOData(input));
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await client.getObject("Incident", input.id, { select: input.select, expand: input.expand });
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await client.createObject("Incident", input.data);
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await client.patchObject("Incident", input.id, input.data);
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await client.getObjects("IncidentType", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
root cause analysis en trendrapportages.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("IncidentCause", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
Statussen: 1=Aangemaakt, 2=Gemeld, 4=In behandeling, 8=Te evalueren, 16=Gereed, 32=Gesloten, 64=Vervallen.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("SafetyIncident", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
32=Te verlengen, 64=Template aangemaakt, 128=Template goedgekeurd.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("Permit", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
