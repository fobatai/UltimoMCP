...
export function registerRestActionTools(server: McpServer, client: UltimoClient) {
  // ==================== MEASUREMENT POINTS ====================
  server.tool(
...
Vereist: Description, EquipmentId, MeasurementPointId. Geen ApplicationElementId nodig.`,
    ...
    async (input) => {
      try {
        const result = await client.executeAction("REST_CreateEquipmentMeasurementPoint", {
          EquipmentId: input.equipment_id,
          MeasurementPointId: input.measurement_point_id,
          Description: input.description,
        }, client.getActionHeaders("REST_CreateEquipmentMeasurementPoint"));
...
Vergelijkbaar met equipment-meetpunten maar gekoppeld aan een ProcessFunction.`,
    ...
    async (input) => {
      try {
        const result = await client.executeAction("REST_CreateProcessFunctionMeasurementPoint", {
          ProcessFunctionId: input.process_function_id,
          MeasurementPointId: input.measurement_point_id,
          Description: input.description,
        }, client.getActionHeaders("REST_CreateProcessFunctionMeasurementPoint"));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
Geeft het aangemaakte UltimoId terug. Vereist: ApplicantId, Description, SpaceId, StartTime, EndTime, ExternalId.`,
    ...
    async (input) => {
      try {
        const result = await client.executeAction("REST_CreateReservation", {
        ...
        }, client.getActionHeaders("REST_CreateReservation"));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
  ...
  server.tool(
    ...
    async (input) => {
      try {
        ...
        const result = await client.executeAction("REST_UpdateReservation", data, client.getActionHeaders("REST_UpdateReservation"));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await client.executeAction("REST_CancelReservation", {
          UltimoId: input.ultimo_id,
        }, client.getActionHeaders("REST_CancelReservation"));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
Retourneert max 100 resultaten als JSON. Dit is een actie, geen reguliere GET — het gebruikt een workflow.`,
    ...
    async (input) => {
      try {
        const result = await client.executeAction("REST_GetReservationsForSpace", {
          SpaceId: input.space_id,
          From: input.from,
          Till: input.till,
        }, client.getActionHeaders("REST_GetReservationsForSpace"));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
de beschrijving nodig hebt zonder alle velden op te halen.`,
    ...
    async (input) => {
      try {
        const result = await client.executeAction("REST_GetDescription", {
          Type: input.type,
          Id: input.id,
        }, client.getActionHeaders("REST_GetDescription"));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
Alle velden zijn optioneel — geef alleen de velden mee die je wilt instellen.`,
    ...
    async (input) => {
      try {
        const result = await client.executeAction("REST_Article_Import", input.data, client.getActionHeaders("REST_Article_Import"));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
Koppelt een leverancier aan een artikel met prijsinformatie, levertijden, en bestelgegevens.`,
    ...
    async (input) => {
      try {
        const result = await client.executeAction("REST_ArticleVendor_Import", input.data, client.getActionHeaders("REST_ArticleVendor_Import"));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
LET OP: deze custom workflow is niet op alle omgevingen beschikbaar.`,
    ...
    async (input) => {
      try {
        ...
        const result = await client.executeAction("_REST_DOCUMENT", data, client.getActionHeaders("_REST_DOCUMENT"));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
LET OP: custom workflow, niet op alle omgevingen beschikbaar.`,
    ...
    async (input) => {
      try {
        ...
        const result = await client.executeAction("_REST_UPLOADJOBDOC", data, client.getActionHeaders("_REST_UPLOADJOBDOC"));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
LET OP: custom workflow, niet op alle omgevingen beschikbaar.`,
    ...
    async (input) => {
      try {
        const result = await client.executeAction("_REST_UPLOADPRFDOC", {
        ...
        }, client.getActionHeaders("_REST_UPLOADPRFDOC"));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
