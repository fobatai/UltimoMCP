...
export function registerInventoryTools(server: McpServer, client: UltimoClient) {
  // Articles
  server.tool(
    "get_articles",
...
E=boven maar onvoldoende, V=voldoende. Expand met ArticleWarehouses, Vendors, EquipmentSpareParts.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("Article", buildOData(input));
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await client.getObject("Article", input.id, { select: input.select, expand: input.expand });
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await client.createObject("Article", input.data);
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await client.patchObject("Article", input.id, input.data);
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await client.getObjects("ArticleGroup", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
Filter op specifiek artikel: $filter=Article eq 'ART-001'.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("ArticleWarehouse", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
inclusief leverancier-artikelnummer, prijs, en levertijd.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("ArticleVendor", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
Elk magazijn heeft locaties (WarehouseLocations) waar artikelen liggen opgeslagen.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("Warehouse", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await client.getObjects("WarehouseLocation", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
Filter op Job of Article.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("Material", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await client.createObject("Material", input.data);
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
zodat het niet voor andere doeleinden uitgegeven wordt.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("Reservation", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await client.createObject("Reservation", input.data);
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
