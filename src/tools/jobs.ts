...
export function registerJobTools(server: McpServer, client: UltimoClient) {
  server.tool(
    "get_jobs",
...
"Department/Id eq '01'" voor filteren op relatie. Expand met Equipment, Employee, PurchaseLines voor meer context.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("Job", buildOData(input));
...
Gebruik 'select' om alleen specifieke velden op te halen.`,
    ...
    async (input) => {
      try {
        const result = await client.getObject("Job", input.id, { select: input.select, expand: input.expand });
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
Extra klantspecifieke velden: Extra1-12, RemarkChar1-7, RemarkDate1-2, RemarkInt1-5, RemarkText1-2.`,
    ...
    async (input) => {
      try {
        const result = await client.createObject("Job", input.data);
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
Voorbeeld: { "Status": "C", "PercentageComplete": 100 } om een job af te melden.`,
    ...
    async (input) => {
      try {
        const result = await client.patchObject("Job", input.id, input.data);
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
ImageFile/ImageFileBase64 (tot 4 afbeeldingen).`,
    ...
    async (input) => {
      try {
        ...
        const actionHeaders = client.getActionHeaders("REST_ReportJob");
        Object.assign(headers, actionHeaders);
        const result = await client.executeAction("REST_ReportJob", data, headers);
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
Handig om te zien wanneer een job is aangemaakt, geactiveerd, voltooid, etc.`,
    ...
    async (input) => {
      try {
        ...
        const result = await client.getObjects("JobProgressStatusHistory", params);
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
Het bevat standaard instructies, benodigde materialen en inspectieregels die bij het aanmaken van een job worden overgenomen.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("JobPlan", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
voor de uitvoering van een job, gekoppeld aan medewerkers en periodes.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("JobSchedulePart", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
Let op: in Ultimo is 'Job' het daadwerkelijke werkitem, 'WorkOrder' is de bovenliggende groepering.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("WorkOrder", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await client.getObject("WorkOrder", input.id, { select: input.select, expand: input.expand });
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await client.createObject("WorkOrder", input.data);
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await client.patchObject("WorkOrder", input.id, input.data);
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
