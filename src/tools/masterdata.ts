...
export function registerMasterDataTools(server: McpServer, client: UltimoClient) {
  server.tool(
    "get_priorities",
    ...
    async (input) => {
      try {
        const result = await client.getObjects("Priority", buildOData(input));
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await client.getObjects("Urgency", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
(bijv. Aangevraagd, Actief, Voltooid, Gesloten). Belangrijk om te weten welke statuswaarden geldig zijn.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("ProgressStatus", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await client.getObjects("WorkOrderType", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
bijv. Kleur, Gewicht, Vermogen. Worden gedefinieerd per EquipmentType.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("Feature", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await client.getObjects("ObjectFeature", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
relevant bij servicebedrijven die voor meerdere klanten werken.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("Customer", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
(specificaties, tekeningen, certificaten).`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("ProductDossier", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
Worden gebruikt bij meetpunten.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("PhysicalQuantity", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await client.getObjects("Unit", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
bijv. storingen, waarnemingen, overdrachten. Worden gebruikt bij procesoperators.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("ShiftLog", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await client.getObjects("ShiftLogbook", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
bijv. meetinstrumenten, gereedschap, of laptops.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("LendableObject", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
en getrackt worden op gebruik en kosten.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("Tool", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await client.getObjects("CustomerSatisfaction", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
Wordt gebruikt bij wagenparkbeheer.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects(input.type, buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
TariffGroup, Vat, ContractLineType, RiskClass, etc.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects(input.object_type, buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
Gebruik dit als fallback wanneer er geen specifieke tool is.`,
    ...
    async (input) => {
      try {
        const result = await client.getObject(input.object_type, input.id, { select: input.select, expand: input.expand });
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
wanneer er geen specifieke tool is. Vereist bevestiging voor destructieve objecttypen.`,
    ...
    async (input) => {
      try {
        const result = await client.createObject(input.object_type, input.data);
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await client.patchObject(input.object_type, input.id, input.data);
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
