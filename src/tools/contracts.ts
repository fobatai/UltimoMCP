...
export function registerContractTools(server: McpServer, client: UltimoClient) {
  server.tool(
...
Filter op Vendor, ContractType, Status, of verloopsdatum.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("ServiceContract", buildOData(input));
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await client.getObject("ServiceContract", input.id, { select: input.select, expand: input.expand });
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await client.createObject("ServiceContract", input.data);
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await client.patchObject("ServiceContract", input.id, input.data);
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
binnen het contract, inclusief afspraken en tarieven.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("ServiceContractLine", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await client.getObjects("ServiceContractType", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await client.getObjects("ServiceContractForm", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
