...
export function registerPurchasingTools(server: McpServer, client: UltimoClient) {
  // Purchases
  server.tool(
    "get_purchases",
...
Inkoopflow: PurchaseRequest → Purchase → Receipt → Invoice → Cost.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("Purchase", buildOData(input));
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await client.getObject("Purchase", input.id, { select: input.select, expand: input.expand });
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await client.createObject("Purchase", input.data);
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await client.patchObject("Purchase", input.id, input.data);
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
Filter op Purchase om regels van een specifieke bestelling te zien.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("PurchaseLine", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
Contexten: 1=Bestelaanvraag, 2=Offertetraject, 4=OrderRequest. Expand met Lines.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("PurchaseRequest", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await client.createObject("PurchaseRequest", input.data);
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
Expand met Lines, Purchase, Vendor, InvoiceLines voor meer context.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("Receipt", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await client.createObject("Receipt", input.data);
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
en servicecontracten. Filter op VendorType, naam, of andere eigenschappen.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("Vendor", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await client.getObject("Vendor", input.id, { select: input.select, expand: input.expand });
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await client.createObject("Vendor", input.data);
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
