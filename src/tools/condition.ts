...
export function registerConditionTools(server: McpServer, client: UltimoClient) {
  server.tool(
...
Wordt veel gebruikt in vastgoedbeheer en infrastructuur.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("ConditionMeasurement", buildOData(input));
...
conditiemeting zijn geconstateerd (bijv. scheuren, corrosie, lekkage).`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("ConditionFlaw", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await client.getObjects("ConditionFlawType", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
en bepalen de urgentie van onderhoud.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("ConditionRisk", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await client.getObjects("ConditionRiskScore", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
tot een totaalscore voor een asset.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("ObjectRiskAnalysis", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await client.getObjects("RiskFactor", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
vanuit verschillende perspectieven (technisch, financieel, functioneel).`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("ConditionInterest", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
