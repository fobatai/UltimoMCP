...
export function registerMaintenanceTools(server: McpServer, client: UltimoClient) {
...
automatisch jobs op basis van het onderhoudsschema. Filter op equipment, frequentie, of status.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("PmWorkOrder", buildOData(input));
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await client.getObject("PmWorkOrder", input.id, { select: input.select, expand: input.expand });
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
de frequentie, en de uit te voeren taken.`,
    ...
    async (input) => {
      try {
        const result = await client.createObject("PmWorkOrder", input.data);
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await client.patchObject("PmWorkOrder", input.id, input.data);
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
Elke PM job definieert een specifieke taak die bij elke onderhoudsbeurt uitgevoerd moet worden.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("PmJob", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
Expand met Lines voor de individuele inspectieregels.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("InspectionPlan", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await client.getObject("InspectionPlan", input.id, { select: input.select, expand: input.expand });
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
gekoppeld aan een job of equipment. Filter op Job, Equipment, of InspectionPlan.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("InspectionLine", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await client.createObject("InspectionLine", input.data);
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
bijv. wekelijks, maandelijks, per 1000 draaiuren. Worden gekoppeld aan PM werkorders.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("Frequency", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await client.getObjects("MaintenanceClassification", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await client.getObjects("MaintenanceState", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
