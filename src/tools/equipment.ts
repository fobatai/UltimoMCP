...
export function registerEquipmentTools(server: McpServer, client: UltimoClient) {
  server.tool(
    "get_equipment",
...
Voorbeeld filter: $filter=EquipmentType eq 'PUMP' or Location eq 'PLANT-A'.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("Equipment", buildOData(input));
...
zoals MeasurementPoints, SpareParts, FailTypes, Jobs.`,
    ...
    async (input) => {
      try {
        const result = await client.getObject("Equipment", input.id, { select: input.select, expand: input.expand });
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
Optioneel: Id, Description, Location, Site, EquipmentType, PartOfEquipment, Tech1-10 (klantspecifiek).`,
    ...
    async (input) => {
      try {
        const result = await client.createObject("Equipment", input.data);
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
Gebruik dit om eigenschappen te wijzigen zoals locatie, status, of technische specificaties.`,
    ...
    async (input) => {
      try {
        const result = await client.patchObject("Equipment", input.id, input.data);
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
Gebruik dit om te weten welke typen beschikbaar zijn bij het aanmaken van nieuw equipment.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("EquipmentType", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
Filter op specifiek equipment met $filter=Equipment eq 'EQ-001'.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("EquipmentMeasurementPoint", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
over tijd. Gebruik dit voor trendanalyse en conditiemonitoring.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("EquipmentMeasurementPointValue", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
Filter op specifiek equipment: $filter=Equipment eq 'EQ-001'.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("EquipmentSparePart", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
In sommige Ultimo-configuraties is Aoc het primaire asset-object.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("Aoc", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
  ...
  server.tool(
    ...
    async (input) => {
      try {
        const result = await client.getObject("Aoc", input.id, { select: input.select, expand: input.expand });
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
Expand met Jobs, Equipments, PmWorkOrders, SpareParts, MeasurementPoints.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("ProcessFunction", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
inclusief begin- en eindtijd en reden. Belangrijk voor OEE-berekeningen en beschikbaarheidsanalyse.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("ObjectDowntime", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
...
bijv. Mechanisch, Elektrisch, Lekkage. Worden gekoppeld aan jobs en equipment.`,
    ...
    async (input) => {
      try {
        const result = await client.getObjects("FailType", buildOData(input));
        return success(result);
      } catch (e: any) {
        return error(e.message);
      }
